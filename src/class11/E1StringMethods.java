...
public class E1StringMethods {
    public static void main(String[] args) {
        ...
        System.out.println(str.charAt(str.length()-1));//length gives us number of elements which is 18
        // thats why we do -1 which is 17. It’s 18 characters but Index start at 0
